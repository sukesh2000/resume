  ...
  (
    ...
    achievements: (
      (
        project: "IDFC Bank",
        points: (
          [Manual and fragmented configuration changes across 98 microservices increased operational effort and outage risk. Contributed to building a Golang based configuration platform with Redis caching, versioned configurations, Kafka-driven rollouts, and automated Conftest/Pact/Helm validation, *reducing configuration time by 60%, database queries by 85%, and increasing adoption by 65%*.],
          ...
          [The existing configuration platform needed secure access from AI-assisted development tools. Designed and implemented a Golang based authentication middleware for an MCP server, enabling secure exposure of configuration-platform capabilities to AI-assisted tools.],
